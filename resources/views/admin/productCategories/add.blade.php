<x-admin-layout title="Add Product Categories">
    <div class="container grid mb-5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Add Product Categories
        </h2>

        <form method="POST" enctype="multipart/form-data" action="{{ route("productCategories.store") }}">
            @csrf
            <!-- General elements -->
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="mt-10 text-sm">
                    <label class="block text-sm">
                        ...
                        <input name="data_type" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Ex: mins, hours, etc" required/>
                    </label>
                </div>
